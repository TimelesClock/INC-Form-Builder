...
-- CreateIndex
CREATE INDEX "Invitation_formId_idx" ON "Invitation"("formId");
...
-- AddForeignKey
ALTER TABLE "Invitation" ADD CONSTRAINT "Invitation_formId_fkey" FOREIGN KEY ("formId") REFERENCES "Form"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
